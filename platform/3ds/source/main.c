 ...
 * is a thing the screen answers rather than something to infer from behaviour. */
...
static void action_survey(void)
{
    ...
    /* Which build wrote this. A survey read on a desktop a week later is worth
     * much less if nobody can say which version produced it. */
    {
        char header[160];
        daemoon_strbuf_t hb;
